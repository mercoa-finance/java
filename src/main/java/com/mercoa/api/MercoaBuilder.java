...
public class MercoaBuilder {
     ...
     */
    public MercoaBuilder maxRetries(int maxRetries) {
     ...
     */
    public MercoaBuilder addHeader(String name, String value) {
    ...
    public Mercoa build() {
        ...
        return new Mercoa(buildClientOptions());
    }
}
