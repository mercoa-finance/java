...
public class AsyncRawCalculateClient {
    protected final ClientOptions clientOptions;

    public AsyncRawCalculateClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<InvoiceFeesResponse>> fee(CalculateFeesRequest request) {
     ...
     * Calculate the estimated fees associated with an payment given the amount, payment source, and disbursement method. Can be used to calculate fees for a payment before creating an invoice.
     */
    public CompletableFuture<MercoaHttpResponse<InvoiceFeesResponse>> fee(
            CalculateFeesRequest request, RequestOptions requestOptions) {
        ...
        CompletableFuture<MercoaHttpResponse<InvoiceFeesResponse>> future = new CompletableFuture<>();
     ...
     */
    public CompletableFuture<MercoaHttpResponse<CalculatePaymentTimingResponse>> paymentTiming(
    ...
    public CompletableFuture<MercoaHttpResponse<CalculatePaymentTimingResponse>> paymentTiming(
        ...
        CompletableFuture<MercoaHttpResponse<CalculatePaymentTimingResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
