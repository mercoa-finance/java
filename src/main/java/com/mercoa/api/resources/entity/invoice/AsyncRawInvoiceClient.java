...
public class AsyncRawInvoiceClient {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<FindInvoiceResponse>> find(String entityId) {
    ...
    public CompletableFuture<MercoaHttpResponse<FindInvoiceResponse>> find(
            String entityId, EntityGetInvoicesRequest request) {
    ...
    public CompletableFuture<MercoaHttpResponse<InvoiceResponse>> get(String entityId, String invoiceId) {
        return get(entityId, invoiceId, null);
    }

    public CompletableFuture<MercoaHttpResponse<InvoiceResponse>> get(
            String entityId, String invoiceId, RequestOptions requestOptions) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<List<InvoiceMetricsResponse>>> metrics(String entityId) {
     ...
     * Get invoice metrics for an entity with the given filters. Invoices will always be grouped by currency. If none of excludePayables, excludeReceivables, payerId, vendorId, or invoiceId status filters are provided, excludeReceivables will be set to true.
     */
    public CompletableFuture<MercoaHttpResponse<List<InvoiceMetricsResponse>>> metrics(
            String entityId, InvoiceMetricsRequest request) {
    ...
    public CompletableFuture<MercoaHttpResponse<List<InvoiceMetricsResponse>>> metrics(
        ...
        CompletableFuture<MercoaHttpResponse<List<InvoiceMetricsResponse>>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<BulkDownloadResponse>> download(String entityId) {
    ...
    public CompletableFuture<MercoaHttpResponse<BulkDownloadResponse>> download(
            String entityId, DownloadEntityInvoicesRequest request) {
