...
public class RawCustomizationClient {
    protected final ClientOptions clientOptions;

    public RawCustomizationClient(ClientOptions clientOptions) {
     ...
     */
    public MercoaHttpResponse<EntityCustomizationResponse> get(String entityId) {
     ...
     * Get entity customization.
     */
    public MercoaHttpResponse<EntityCustomizationResponse> get(String entityId, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MercoaHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), EntityCustomizationResponse.class),
                        response);
            }
     ...
     */
    public MercoaHttpResponse<EntityCustomizationResponse> update(String entityId) {
     ...
     * Update entity customization. This lets you turn off metadata and payment methods for an entity.
     */
    public MercoaHttpResponse<EntityCustomizationResponse> update(String entityId, EntityCustomizationRequest request) {
     ...
     * Update entity customization. This lets you turn off metadata and payment methods for an entity.
     */
    public MercoaHttpResponse<EntityCustomizationResponse> update(
