...
public class RawVendorCreditClient {
    protected final ClientOptions clientOptions;

    public RawVendorCreditClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public MercoaHttpResponse<FindVendorCreditResponse> getAll(String entityId, String counterpartyId) {
        return getAll(entityId, counterpartyId, null);
    }

    public MercoaHttpResponse<FindVendorCreditResponse> getAll(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MercoaHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), FindVendorCreditResponse.class),
                        response);
            }
    ...
    public MercoaHttpResponse<VendorCreditResponse> get(String entityId, String counterpartyId, String vendorCreditId) {
        return get(entityId, counterpartyId, vendorCreditId, null);
    }

    public MercoaHttpResponse<VendorCreditResponse> get(
    ...
    public MercoaHttpResponse<VendorCreditResponse> create(
    ...
    public MercoaHttpResponse<Void> delete(String entityId, String counterpartyId, String vendorCreditId) {
        return delete(entityId, counterpartyId, vendorCreditId, null);
    }

    public MercoaHttpResponse<Void> delete(
            String entityId, String counterpartyId, String vendorCreditId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("entity")
     ...
     */
    public MercoaHttpResponse<CalculateVendorCreditUsageResponse> estimateUsage(
