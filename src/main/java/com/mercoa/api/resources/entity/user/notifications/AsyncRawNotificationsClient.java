...
public class AsyncRawNotificationsClient {
    ...
    public CompletableFuture<MercoaHttpResponse<FindNotificationResponse>> find(String entityId, String userId) {
        return find(entityId, userId, EntityGetNotificationsRequest.builder().build());
    }

    public CompletableFuture<MercoaHttpResponse<FindNotificationResponse>> find(
    ...
    public CompletableFuture<MercoaHttpResponse<FindNotificationResponse>> find(
        ...
        CompletableFuture<MercoaHttpResponse<FindNotificationResponse>> future = new CompletableFuture<>();
    ...
    public CompletableFuture<MercoaHttpResponse<NotificationResponse>> get(
            String entityId, String userId, String notificationId) {
    ...
    public CompletableFuture<MercoaHttpResponse<NotificationResponse>> get(
        ...
        CompletableFuture<MercoaHttpResponse<NotificationResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<NotificationResponse>> update(
            String entityId, String userId, String notificationId) {
        return update(
                entityId,
                userId,
