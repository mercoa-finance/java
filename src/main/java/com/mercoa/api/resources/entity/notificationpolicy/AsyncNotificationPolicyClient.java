...
public class AsyncNotificationPolicyClient {
    ...
    public CompletableFuture<List<NotificationPolicyResponse>> getAll(String entityId, RequestOptions requestOptions) {
        ...
        CompletableFuture<List<NotificationPolicyResponse>> future = new CompletableFuture<>();
    ...
    public CompletableFuture<NotificationPolicyResponse> get(
        ...
        CompletableFuture<NotificationPolicyResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(ObjectMappers.JSON_MAPPER.readValue(
                                responseBody.string(), NotificationPolicyResponse.class));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                    future.completeExceptionally(new MercoaApiException(
