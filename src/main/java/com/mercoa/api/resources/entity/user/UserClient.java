...
public class UserClient {
     ...
     * Search entity users
     */
    public FindEntityUserResponse findOld(String entityId) {
        return this.rawClient.findOld(entityId).body();
    }

    /**
     * Search entity users
     */
    public FindEntityUserResponse findOld(String entityId, EntityFindOldEntityRequest request) {
        return this.rawClient.findOld(entityId, request).body();
    }

    /**
     * Search entity users
     */
    public FindEntityUserResponse findOld(
            String entityId, EntityFindOldEntityRequest request, RequestOptions requestOptions) {
        return this.rawClient.findOld(entityId, request, requestOptions).body();
    }
     ...
     */
    public String getNoOptionToken(String entityId, String userId) {
        return this.rawClient.getNoOptionToken(entityId, userId).body();
    }

    /**
     * Get JWT token for entity user
     */
    public String getNoOptionToken(String entityId, String userId, RequestOptions requestOptions) {
        return this.rawClient.getNoOptionToken(entityId, userId, requestOptions).body();
    }
