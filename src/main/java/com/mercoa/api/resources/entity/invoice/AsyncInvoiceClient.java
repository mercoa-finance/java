...
public class AsyncInvoiceClient {
    ...
    public CompletableFuture<InvoiceResponse> get(String entityId, String invoiceId) {
        return this.rawClient.get(entityId, invoiceId).thenApply(response -> response.body());
    }

    public CompletableFuture<InvoiceResponse> get(String entityId, String invoiceId, RequestOptions requestOptions) {
        return this.rawClient.get(entityId, invoiceId, requestOptions).thenApply(response -> response.body());
    }
