 ...
 */
package com.mercoa.api.resources.entity.counterparty.bulk.requests;
...
@JsonDeserialize(builder = DownloadBulkPayeesRequest.Builder.class)
public final class DownloadBulkPayeesRequest {
    ...
    private DownloadBulkPayeesRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DownloadBulkPayeesRequest && equalTo((DownloadBulkPayeesRequest) other);
    }
    ...
    private boolean equalTo(DownloadBulkPayeesRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(DownloadBulkPayeesRequest other) {
        ...
        public DownloadBulkPayeesRequest build() {
            return new DownloadBulkPayeesRequest(
                    networkType,
                    counterpartyId,
                    metadata,
                    returnMetadata,
