...
public class RawUserClient {
     ...
     * Search entity users
     */
    public MercoaHttpResponse<FindEntityUserResponse> findOld(String entityId) {
     ...
     * Search entity users
     */
    public MercoaHttpResponse<FindEntityUserResponse> findOld(String entityId, EntityFindOldEntityRequest request) {
     ...
     * Search entity users
     */
    public MercoaHttpResponse<FindEntityUserResponse> findOld(
     ...
     */
    public MercoaHttpResponse<String> getNoOptionToken(String entityId, String userId) {
     ...
     * Get JWT token for entity user
     */
    public MercoaHttpResponse<String> getNoOptionToken(String entityId, String userId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("entity")
                .addPathSegment(entityId)
