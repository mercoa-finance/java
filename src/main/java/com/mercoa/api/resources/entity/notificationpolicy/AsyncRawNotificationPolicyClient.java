...
public class AsyncRawNotificationPolicyClient {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<List<NotificationPolicyResponse>>> getAll(String entityId) {
     ...
     * Retrieve all notification policies associated with this entity
     */
    public CompletableFuture<MercoaHttpResponse<List<NotificationPolicyResponse>>> getAll(
        ...
        CompletableFuture<MercoaHttpResponse<List<NotificationPolicyResponse>>> future = new CompletableFuture<>();
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new MercoaHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBody.string(),
                                        new TypeReference<List<NotificationPolicyResponse>>() {}),
                                response));
                        return;
                    }
     ...
     */
    public CompletableFuture<MercoaHttpResponse<NotificationPolicyResponse>> get(
            String entityId, NotificationType notificationType) {
    ...
    public CompletableFuture<MercoaHttpResponse<NotificationPolicyResponse>> get(
        ...
        CompletableFuture<MercoaHttpResponse<NotificationPolicyResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<NotificationPolicyResponse>> update(
            String entityId, NotificationType notificationType) {
        return update(
