...
public class AsyncRawRepresentativeClient {
    protected final ClientOptions clientOptions;

    public AsyncRawRepresentativeClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<List<RepresentativeResponse>>> getAll(String entityId) {
     ...
     * Get representatives for an entity
     */
    public CompletableFuture<MercoaHttpResponse<List<RepresentativeResponse>>> getAll(
        ...
        CompletableFuture<MercoaHttpResponse<List<RepresentativeResponse>>> future = new CompletableFuture<>();
    ...
    public CompletableFuture<MercoaHttpResponse<RepresentativeResponse>> create(
            String entityId, RepresentativeRequest request) {
    ...
    public CompletableFuture<MercoaHttpResponse<RepresentativeResponse>> create(
        ...
        CompletableFuture<MercoaHttpResponse<RepresentativeResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<MercoaHttpResponse<RepresentativeResponse>> get(String entityId, String representativeId) {
        return get(entityId, representativeId, null);
    }

    public CompletableFuture<MercoaHttpResponse<RepresentativeResponse>> get(
    ...
    public CompletableFuture<MercoaHttpResponse<RepresentativeResponse>> update(
            String entityId, String representativeId) {
        return update(
                entityId,
                representativeId,
    ...
    public CompletableFuture<MercoaHttpResponse<Void>> delete(String entityId, String representativeId) {
