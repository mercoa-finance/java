...
import com.mercoa.api.resources.entity.user.requests.EntityFindOldEntityRequest;
...
public class AsyncRawUserClient {
     ...
     * Search entity users
     */
    public CompletableFuture<MercoaHttpResponse<FindEntityUserResponse>> find(String entityId) {
     ...
     * Search entity users
     */
    public CompletableFuture<MercoaHttpResponse<FindEntityUserResponse>> find(
            String entityId, EntityFindEntityRequest request) {
    ...
    public CompletableFuture<MercoaHttpResponse<FindEntityUserResponse>> find(
        ...
        CompletableFuture<MercoaHttpResponse<FindEntityUserResponse>> future = new CompletableFuture<>();
     ...
     * Search entity users
     */
    public CompletableFuture<MercoaHttpResponse<FindEntityUserResponse>> findOld(String entityId) {
        return findOld(entityId, EntityFindOldEntityRequest.builder().build());
    }

    /**
     * Search entity users
     */
    public CompletableFuture<MercoaHttpResponse<FindEntityUserResponse>> findOld(
            String entityId, EntityFindOldEntityRequest request) {
        return findOld(entityId, request, null);
    }
     ...
     */
    public CompletableFuture<MercoaHttpResponse<FindEntityUserResponse>> findOld(
            String entityId, EntityFindOldEntityRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("entity")
                .addPathSegment(entityId)
    ...
    public CompletableFuture<MercoaHttpResponse<EntityUserResponse>> create(String entityId) {
        return create(entityId, EntityUserRequest.builder().build());
    }

    public CompletableFuture<MercoaHttpResponse<EntityUserResponse>> create(
            String entityId, EntityUserRequest request) {
    ...
    public CompletableFuture<MercoaHttpResponse<EntityUserResponse>> create(
        ...
        CompletableFuture<MercoaHttpResponse<EntityUserResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     * Get entity user
     */
    public CompletableFuture<MercoaHttpResponse<EntityUserResponse>> get(String entityId, String userId) {
     ...
     * Get entity user
     */
    public CompletableFuture<MercoaHttpResponse<EntityUserResponse>> get(
     ...
     * Update entity user
     */
    public CompletableFuture<MercoaHttpResponse<EntityUserResponse>> update(String entityId, String userId) {
     ...
     * Update entity user
     */
    public CompletableFuture<MercoaHttpResponse<EntityUserResponse>> update(
            String entityId, String userId, EntityUserRequest request) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<Void>> delete(String entityId, String userId) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<String>> getNoOptionToken(String entityId, String userId) {
        return getNoOptionToken(entityId, userId, null);
    }
     ...
     */
    public CompletableFuture<MercoaHttpResponse<String>> getToken(String entityId, String userId) {
    ...
    public CompletableFuture<MercoaHttpResponse<String>> getToken(
            String entityId, String userId, TokenGenerationOptions request) {
