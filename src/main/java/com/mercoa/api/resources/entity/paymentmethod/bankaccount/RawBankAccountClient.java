...
public class RawBankAccountClient {
    protected final ClientOptions clientOptions;

    public RawBankAccountClient(ClientOptions clientOptions) {
     ...
     */
    public MercoaHttpResponse<PaymentMethodResponse> initiateMicroDeposits(String entityId, String paymentMethodId) {
     ...
     * Initiate micro deposits for a bank account
     */
    public MercoaHttpResponse<PaymentMethodResponse> initiateMicroDeposits(
     ...
     */
    public MercoaHttpResponse<PaymentMethodResponse> completeMicroDeposits(
     ...
     */
    public MercoaHttpResponse<AccelerationFundsResponse> getAccelerationFunds(String entityId, String paymentMethodId) {
     ...
     * Get the available and pending balance of this entity's acceleration funds. The specified payment method must be a bank account.
     */
    public MercoaHttpResponse<AccelerationFundsResponse> getAccelerationFunds(
            String entityId, String paymentMethodId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("entity")
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MercoaHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), AccelerationFundsResponse.class),
                        response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new MercoaApiException(
     ...
     */
    public MercoaHttpResponse<Void> addAccelerationFunds(
     ...
     */
    public MercoaHttpResponse<Void> removeAccelerationFunds(
     ...
     */
    public MercoaHttpResponse<PaymentMethodBalanceResponse> getBalance(String entityId, String paymentMethodId) {
     ...
     * Deprecated. Get the available balance of a payment method. Only bank accounts added with Plaid are supported. This endpoint will return a cached value and will refresh the balance when called.
     */
    public MercoaHttpResponse<PaymentMethodBalanceResponse> getBalance(
            String entityId, String paymentMethodId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("entity")
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MercoaHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), PaymentMethodBalanceResponse.class),
                        response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new MercoaApiException(
