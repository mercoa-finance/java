...
public class AsyncRawApprovalPolicyClient {
    protected final ClientOptions clientOptions;

    public AsyncRawApprovalPolicyClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<List<ApprovalPolicyResponse>>> getAll(String entityId) {
     ...
     * Retrieve all invoice approval policies associated with an entity
     */
    public CompletableFuture<MercoaHttpResponse<List<ApprovalPolicyResponse>>> getAll(
        ...
        CompletableFuture<MercoaHttpResponse<List<ApprovalPolicyResponse>>> future = new CompletableFuture<>();
     ...
     */
    public CompletableFuture<MercoaHttpResponse<ApprovalPolicyResponse>> create(
            String entityId, ApprovalPolicyRequest request) {
    ...
    public CompletableFuture<MercoaHttpResponse<ApprovalPolicyResponse>> create(
        ...
        CompletableFuture<MercoaHttpResponse<ApprovalPolicyResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<ApprovalPolicyResponse>> get(String entityId, String policyId) {
     ...
     * Retrieve an invoice approval policy associated with an entity
     */
    public CompletableFuture<MercoaHttpResponse<ApprovalPolicyResponse>> get(
     ...
     */
    public CompletableFuture<MercoaHttpResponse<ApprovalPolicyResponse>> update(String entityId, String policyId) {
     ...
     * Update an invoice approval policy associated with an entity
     */
    public CompletableFuture<MercoaHttpResponse<ApprovalPolicyResponse>> update(
     ...
     */
    public CompletableFuture<MercoaHttpResponse<Void>> delete(String entityId, String policyId) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<List<ApprovalPolicyHistoryResponse>>> history(String entityId) {
     ...
     * Retrieve the history of approval policy changes for an entity
     */
    public CompletableFuture<MercoaHttpResponse<List<ApprovalPolicyHistoryResponse>>> history(
            String entityId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("entity")
        ...
        CompletableFuture<MercoaHttpResponse<List<ApprovalPolicyHistoryResponse>>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new MercoaHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBody.string(),
                                        new TypeReference<List<ApprovalPolicyHistoryResponse>>() {}),
                                response));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
     ...
     */
    public CompletableFuture<MercoaHttpResponse<List<ApprovalPolicyResponse>>> restore(
            String entityId, String approvalPolicyHistoryId) {
