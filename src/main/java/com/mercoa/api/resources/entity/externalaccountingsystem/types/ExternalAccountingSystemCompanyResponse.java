...
public final class ExternalAccountingSystemCompanyResponse {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private ExternalAccountingSystemCompanyResponse(Value value) {
        this.value = value;
    }
    ...
    public static ExternalAccountingSystemCompanyResponse codat(CodatCompanyResponse value) {
    ...
    private static final class CodatValue implements Value {
        ...
        private CodatValue(CodatCompanyResponse value) {
            this.value = value;
        }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "ExternalAccountingSystemCompanyResponse{" + "type: " + type + ", value: " + value + "}";
        }
    }
}
