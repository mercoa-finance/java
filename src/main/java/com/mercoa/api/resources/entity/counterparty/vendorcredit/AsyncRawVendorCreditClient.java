...
public class AsyncRawVendorCreditClient {
    protected final ClientOptions clientOptions;

    public AsyncRawVendorCreditClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public CompletableFuture<MercoaHttpResponse<FindVendorCreditResponse>> getAll(
            String entityId, String counterpartyId) {
    ...
    public CompletableFuture<MercoaHttpResponse<FindVendorCreditResponse>> getAll(
        ...
        CompletableFuture<MercoaHttpResponse<FindVendorCreditResponse>> future = new CompletableFuture<>();
    ...
    public CompletableFuture<MercoaHttpResponse<VendorCreditResponse>> get(
            String entityId, String counterpartyId, String vendorCreditId) {
    ...
    public CompletableFuture<MercoaHttpResponse<VendorCreditResponse>> get(
        ...
        CompletableFuture<MercoaHttpResponse<VendorCreditResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<MercoaHttpResponse<VendorCreditResponse>> create(
     ...
     */
    public CompletableFuture<MercoaHttpResponse<CalculateVendorCreditUsageResponse>> estimateUsage(
    ...
    public CompletableFuture<MercoaHttpResponse<CalculateVendorCreditUsageResponse>> estimateUsage(
        ...
        QueryStringMapper.addQueryParameter(httpUrl, "amount", request.getAmount(), false);
        ...
        if (request.getExcludedInvoiceIds().isPresent()) {
            QueryStringMapper.addQueryParameter(
                    httpUrl,
                    "excludedInvoiceIds",
                    request.getExcludedInvoiceIds().get(),
                    false);
        }
        if (request.getIncludedVendorCreditIds().isPresent()) {
            QueryStringMapper.addQueryParameter(
                    ...
                    request.getIncludedVendorCreditIds().get(),
                    false);
        }
        ...
        CompletableFuture<MercoaHttpResponse<CalculateVendorCreditUsageResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
