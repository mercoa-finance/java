...
public class AsyncRawPaymentMethodClient {
    protected final ClientOptions clientOptions;

    public AsyncRawPaymentMethodClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public CompletableFuture<MercoaHttpResponse<List<PaymentMethodResponse>>> getAll(String entityId) {
        return getAll(entityId, GetAllPaymentMethodsRequest.builder().build());
    }

    public CompletableFuture<MercoaHttpResponse<List<PaymentMethodResponse>>> getAll(
    ...
    public CompletableFuture<MercoaHttpResponse<List<PaymentMethodResponse>>> getAll(
        ...
        CompletableFuture<MercoaHttpResponse<List<PaymentMethodResponse>>> future = new CompletableFuture<>();
    ...
    public CompletableFuture<MercoaHttpResponse<PaymentMethodResponse>> create(
            String entityId, PaymentMethodRequest request) {
    ...
    public CompletableFuture<MercoaHttpResponse<PaymentMethodResponse>> get(String entityId, String paymentMethodId) {
        return get(entityId, paymentMethodId, null);
    }

    public CompletableFuture<MercoaHttpResponse<PaymentMethodResponse>> get(
     ...
     */
    public CompletableFuture<MercoaHttpResponse<PaymentMethodResponse>> update(
     ...
     */
    public CompletableFuture<MercoaHttpResponse<Void>> delete(String entityId, String paymentMethodId) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<String>> plaidLinkToken(String entityId) {
     ...
     * Get a Plaid link token for an entity. This token can be used to add or update a bank account to the entity using Plaid Link.
     */
    public CompletableFuture<MercoaHttpResponse<String>> plaidLinkToken(
            String entityId, PlaidLinkTokenRequest request) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<CardLinkTokenResponse>> cardLinkToken(String entityId) {
     ...
     * Get a card link token for an entity. This token is used by the frontend components to generate a PCI compliant form to add a card to the entity.
     */
    public CompletableFuture<MercoaHttpResponse<CardLinkTokenResponse>> cardLinkToken(
        ...
        CompletableFuture<MercoaHttpResponse<CardLinkTokenResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<MercoaHttpResponse<PaymentMethodEventsResponse>> events(
    ...
    public CompletableFuture<MercoaHttpResponse<PaymentMethodEventsResponse>> events(
        ...
        CompletableFuture<MercoaHttpResponse<PaymentMethodEventsResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
