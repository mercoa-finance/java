...
public class EntityClient {
    ...
    public void processKyb(String entityId, ProcessKybRequest request) {
        this.rawClient.processKyb(entityId, request).body();
    }

    public void processKyb(String entityId, ProcessKybRequest request, RequestOptions requestOptions) {
        this.rawClient.processKyb(entityId, request, requestOptions).body();
    }

    /**
     * Get JWT token for entity
     */
    public String getNoOptionToken(String entityId) {
        return this.rawClient.getNoOptionToken(entityId).body();
    }

    /**
     * Get JWT token for entity
     */
    public String getNoOptionToken(String entityId, RequestOptions requestOptions) {
        return this.rawClient.getNoOptionToken(entityId, requestOptions).body();
    }
