...
public class RawNotificationPolicyClient {
    protected final ClientOptions clientOptions;

    public RawNotificationPolicyClient(ClientOptions clientOptions) {
     ...
     */
    public MercoaHttpResponse<List<NotificationPolicyResponse>> getAll(String entityId) {
     ...
     * Retrieve all notification policies associated with this entity
     */
    public MercoaHttpResponse<List<NotificationPolicyResponse>> getAll(String entityId, RequestOptions requestOptions) {
     ...
     */
    public MercoaHttpResponse<NotificationPolicyResponse> get(String entityId, NotificationType notificationType) {
     ...
     * Retrieve notification policy associated with this entity
     */
    public MercoaHttpResponse<NotificationPolicyResponse> get(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MercoaHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), NotificationPolicyResponse.class),
                        response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new MercoaApiException(
     ...
     */
    public MercoaHttpResponse<NotificationPolicyResponse> update(String entityId, NotificationType notificationType) {
        return update(
     ...
     * Update notification policy associated with this entity
     */
    public MercoaHttpResponse<NotificationPolicyResponse> update(
