...
public class RawEntityClient {
    ...
    public MercoaHttpResponse<Void> processKyb(String entityId, ProcessKybRequest request) {
        return processKyb(entityId, request, null);
    }

    public MercoaHttpResponse<Void> processKyb(
     ...
     */
    public MercoaHttpResponse<String> getNoOptionToken(String entityId) {
     ...
     * Get JWT token for entity
     */
    public MercoaHttpResponse<String> getNoOptionToken(String entityId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("entity")
                .addPathSegment(entityId)
