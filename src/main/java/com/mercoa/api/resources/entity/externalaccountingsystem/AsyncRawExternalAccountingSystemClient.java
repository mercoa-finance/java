...
public class AsyncRawExternalAccountingSystemClient {
    protected final ClientOptions clientOptions;

    public AsyncRawExternalAccountingSystemClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<ExternalAccountingSystemCompanyResponse>> get(String entityId) {
     ...
     * Get the external accounting system connected to an entity
     */
    public CompletableFuture<MercoaHttpResponse<ExternalAccountingSystemCompanyResponse>> get(
        ...
        CompletableFuture<MercoaHttpResponse<ExternalAccountingSystemCompanyResponse>> future =
     ...
     */
    public CompletableFuture<MercoaHttpResponse<ExternalAccountingSystemCompanyResponse>> create(
     ...
     */
    public CompletableFuture<MercoaHttpResponse<String>> connect(String entityId) {
     ...
     * Get a link to connect an entity to an external accounting system like Quickbooks or Xero
     */
    public CompletableFuture<MercoaHttpResponse<String>> connect(String entityId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("entity")
                .addPathSegment(entityId)
     ...
     */
    public CompletableFuture<MercoaHttpResponse<Void>> sync(String entityId) {
     ...
     * Sync an entity with an external accounting system. Will sync customers/vendors and invoices.
     */
    public CompletableFuture<MercoaHttpResponse<Void>> sync(String entityId, SyncExternalSystemRequest request) {
