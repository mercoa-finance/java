...
public class RawWalletClient {
     ...
     */
    public MercoaHttpResponse<WalletBalanceResponse> getWalletBalance(String entityId, String paymentMethodId) {
     ...
     * Get the available and pending balance of this entity's wallet. The specified payment method ID must refer to the entity's wallet.
     */
    public MercoaHttpResponse<WalletBalanceResponse> getWalletBalance(
     ...
     */
    public MercoaHttpResponse<Void> addWalletFunds(
     ...
     */
    public MercoaHttpResponse<Void> withdrawWalletFunds(
