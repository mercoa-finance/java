...
public class AsyncRawNotificationPolicyClient {
    protected final ClientOptions clientOptions;

    public AsyncRawNotificationPolicyClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<List<UserNotificationPolicyResponse>>> getAll(
    ...
    public CompletableFuture<MercoaHttpResponse<List<UserNotificationPolicyResponse>>> getAll(
        ...
        CompletableFuture<MercoaHttpResponse<List<UserNotificationPolicyResponse>>> future = new CompletableFuture<>();
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new MercoaHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBody.string(),
                                        new TypeReference<List<UserNotificationPolicyResponse>>() {}),
                                response));
                        return;
                    }
     ...
     */
    public CompletableFuture<MercoaHttpResponse<UserNotificationPolicyResponse>> get(
    ...
    public CompletableFuture<MercoaHttpResponse<UserNotificationPolicyResponse>> get(
        ...
        CompletableFuture<MercoaHttpResponse<UserNotificationPolicyResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new MercoaHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBody.string(), UserNotificationPolicyResponse.class),
                                response));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
     ...
     */
    public CompletableFuture<MercoaHttpResponse<UserNotificationPolicyResponse>> update(
            String entityId, String userId, NotificationType notificationType) {
        return update(
                entityId,
                userId,
