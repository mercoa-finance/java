...
@JsonDeserialize(builder = PaymentMethodEventsRequest.Builder.class)
public final class PaymentMethodEventsRequest {
    ...
    private PaymentMethodEventsRequest(
    ...
    /**
     * @return Limit the number of events returned. Limit can range between 1 and 100, and the default is 50.
     */
    @JsonProperty("limit")
    ...
    /**
     * @return The ID of the event to start after.
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PaymentMethodEventsRequest && equalTo((PaymentMethodEventsRequest) other);
    }
    ...
    private boolean equalTo(PaymentMethodEventsRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(PaymentMethodEventsRequest other) {
        ...
        public PaymentMethodEventsRequest build() {
            return new PaymentMethodEventsRequest(startDate, endDate, limit, startingAfter, additionalProperties);
        }
    }
}
