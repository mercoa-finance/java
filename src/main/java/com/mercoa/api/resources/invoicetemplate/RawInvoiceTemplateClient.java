...
public class RawInvoiceTemplateClient {
    protected final ClientOptions clientOptions;

    public RawInvoiceTemplateClient(ClientOptions clientOptions) {
     ...
     */
    public MercoaHttpResponse<FindInvoiceTemplateResponse> find() {
     ...
     * Search invoice templates for all entities in the organization
     */
    public MercoaHttpResponse<FindInvoiceTemplateResponse> find(GetAllInvoiceTemplatesRequest request) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MercoaHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), FindInvoiceTemplateResponse.class),
                        response);
            }
    ...
    public MercoaHttpResponse<InvoiceTemplateResponse> create() {
        return create(InvoiceTemplateCreationRequest.builder().build());
    }

    public MercoaHttpResponse<InvoiceTemplateResponse> create(InvoiceTemplateCreationRequest request) {
    ...
    public MercoaHttpResponse<InvoiceTemplateResponse> create(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MercoaHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), InvoiceTemplateResponse.class),
                        response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new MercoaApiException(
    ...
    public MercoaHttpResponse<InvoiceTemplateResponse> get(String invoiceTemplateId) {
        return get(invoiceTemplateId, null);
    }

    public MercoaHttpResponse<InvoiceTemplateResponse> get(String invoiceTemplateId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("invoice-template")
    ...
    public MercoaHttpResponse<InvoiceTemplateResponse> update(String invoiceTemplateId) {
        return update(invoiceTemplateId, InvoiceTemplateUpdateRequest.builder().build());
    }

    public MercoaHttpResponse<InvoiceTemplateResponse> update(
     ...
     */
    public MercoaHttpResponse<Void> delete(String invoiceTemplateId) {
     ...
     * Only invoice templates in the UNASSIGNED and DRAFT statuses can be deleted.
     */
    public MercoaHttpResponse<Void> delete(String invoiceTemplateId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("invoice-template")
                .addPathSegment(invoiceTemplateId)
