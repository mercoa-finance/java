...
public class AsyncRawInvoiceTemplateClient {
    protected final ClientOptions clientOptions;

    public AsyncRawInvoiceTemplateClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<FindInvoiceTemplateResponse>> find() {
    ...
    public CompletableFuture<MercoaHttpResponse<FindInvoiceTemplateResponse>> find(
        ...
        CompletableFuture<MercoaHttpResponse<FindInvoiceTemplateResponse>> future = new CompletableFuture<>();
    ...
    public CompletableFuture<MercoaHttpResponse<InvoiceTemplateResponse>> create() {
    ...
    public CompletableFuture<MercoaHttpResponse<InvoiceTemplateResponse>> get(String invoiceTemplateId) {
        return get(invoiceTemplateId, null);
    }

    public CompletableFuture<MercoaHttpResponse<InvoiceTemplateResponse>> get(
    ...
    public CompletableFuture<MercoaHttpResponse<InvoiceTemplateResponse>> update(String invoiceTemplateId) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<Void>> delete(String invoiceTemplateId) {
     ...
     * Only invoice templates in the UNASSIGNED and DRAFT statuses can be deleted.
     */
    public CompletableFuture<MercoaHttpResponse<Void>> delete(String invoiceTemplateId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("invoice-template")
                .addPathSegment(invoiceTemplateId)
