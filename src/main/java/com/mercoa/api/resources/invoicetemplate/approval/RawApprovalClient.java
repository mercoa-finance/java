...
public class RawApprovalClient {
     ...
     */
    public MercoaHttpResponse<Void> addApprover(String invoiceTemplateId, AddApproverRequest request) {
    ...
    public MercoaHttpResponse<Void> approve(String invoiceTemplateId, ApprovalRequest request) {
        return approve(invoiceTemplateId, request, null);
    }

    public MercoaHttpResponse<Void> approve(
    ...
    public MercoaHttpResponse<Void> reject(String invoiceTemplateId, ApprovalRequest request) {
        return reject(invoiceTemplateId, request, null);
    }

    public MercoaHttpResponse<Void> reject(
            String invoiceTemplateId, ApprovalRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("invoice-template")
