...
public class AsyncRawDocumentClient {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<List<DocumentResponse>>> getAll(String invoiceTemplateId) {
    ...
    public CompletableFuture<MercoaHttpResponse<List<DocumentResponse>>> getAll(
            String invoiceTemplateId, GetDocumentsRequest request) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<Void>> upload(String invoiceTemplateId, UploadDocumentRequest request) {
        return upload(invoiceTemplateId, request, null);
    }
     ...
     */
    public CompletableFuture<MercoaHttpResponse<Void>> delete(String invoiceTemplateId, String documentId) {
        return delete(invoiceTemplateId, documentId, null);
    }
    ...
    public CompletableFuture<MercoaHttpResponse<Void>> delete(
            String invoiceTemplateId, String documentId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("invoice-template")
                .addPathSegment(invoiceTemplateId)
     ...
     */
    public CompletableFuture<MercoaHttpResponse<DocumentResponse>> generateInvoicePdf(String invoiceTemplateId) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<DocumentResponse>> generateCheckPdf(String invoiceTemplateId) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<EmailLogResponse>> getSourceEmail(String invoiceTemplateId) {
