...
public class RawDocumentClient {
     ...
     */
    public MercoaHttpResponse<List<DocumentResponse>> getAll(String invoiceTemplateId) {
     ...
     * Get attachments (scanned/uploaded PDFs and images) associated with this invoice template
     */
    public MercoaHttpResponse<List<DocumentResponse>> getAll(String invoiceTemplateId, GetDocumentsRequest request) {
     ...
     */
    public MercoaHttpResponse<Void> upload(String invoiceTemplateId, UploadDocumentRequest request) {
     ...
     */
    public MercoaHttpResponse<Void> delete(String invoiceTemplateId, String documentId) {
     ...
     * Delete an attachment (scanned/uploaded PDFs and images) associated with this invoice template
     */
    public MercoaHttpResponse<Void> delete(String invoiceTemplateId, String documentId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("invoice-template")
                .addPathSegment(invoiceTemplateId)
     ...
     */
    public MercoaHttpResponse<DocumentResponse> generateInvoicePdf(String invoiceTemplateId) {
     ...
     * Generate a PDF of the invoice. This PDF is generated from the data in the invoice, not from the uploaded documents.
     */
    public MercoaHttpResponse<DocumentResponse> generateInvoicePdf(
     ...
     */
    public MercoaHttpResponse<DocumentResponse> generateCheckPdf(String invoiceTemplateId) {
     ...
     * Get a PDF of the check for the invoice. If the invoice does not have check as the disbursement method, an error will be returned. If the disbursement option for the check is set to 'MAIL', a void copy of the check will be returned. If the disbursement option for the check is set to 'PRINT', a printable check will be returned. If the invoice is NOT marked as PAID, the check will be a void copy.
     */
    public MercoaHttpResponse<DocumentResponse> generateCheckPdf(
            String invoiceTemplateId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("invoice-template")
     ...
     */
    public MercoaHttpResponse<EmailLogResponse> getSourceEmail(String invoiceTemplateId) {
     ...
     * Get the email subject and body that was used to create this invoice.
     */
    public MercoaHttpResponse<EmailLogResponse> getSourceEmail(
            String invoiceTemplateId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("invoice-template")
