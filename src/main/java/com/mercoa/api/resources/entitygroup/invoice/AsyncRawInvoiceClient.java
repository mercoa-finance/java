...
public class AsyncRawInvoiceClient {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<FindInvoiceResponse>> find(String entityGroupId) {
    ...
    public CompletableFuture<MercoaHttpResponse<FindInvoiceResponse>> find(
            String entityGroupId, EntityGetInvoicesRequest request) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<BulkDownloadResponse>> download(String entityGroupId) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<List<InvoiceMetricsResponse>>> metrics(String entityGroupId) {
