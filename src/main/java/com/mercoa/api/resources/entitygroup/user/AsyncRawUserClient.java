...
public class AsyncRawUserClient {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<FindEntityGroupUserResponse>> find(String entityGroupId) {
     ...
     * Search entity group users
     */
    public CompletableFuture<MercoaHttpResponse<FindEntityGroupUserResponse>> find(
            String entityGroupId, EntityFindEntityRequest request) {
    ...
    public CompletableFuture<MercoaHttpResponse<FindEntityGroupUserResponse>> find(
        ...
        CompletableFuture<MercoaHttpResponse<FindEntityGroupUserResponse>> future = new CompletableFuture<>();
     ...
     */
    public CompletableFuture<MercoaHttpResponse<EntityGroupUserResponse>> create(
            String entityGroupId, EntityGroupUserRequest request) {
    ...
    public CompletableFuture<MercoaHttpResponse<EntityGroupUserResponse>> create(
        ...
        CompletableFuture<MercoaHttpResponse<EntityGroupUserResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<EntityGroupUserResponse>> get(String entityGroupId, String foreignId) {
     ...
     * Get entity user from a group
     */
    public CompletableFuture<MercoaHttpResponse<EntityGroupUserResponse>> get(
     ...
     */
    public CompletableFuture<MercoaHttpResponse<EntityGroupUserResponse>> update(
     ...
     */
    public CompletableFuture<MercoaHttpResponse<Void>> delete(String entityGroupId, String foreignId) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<String>> getToken(String entityGroupId, String foreignId) {
        return getToken(
    ...
    public CompletableFuture<MercoaHttpResponse<String>> getToken(
            String entityGroupId, String foreignId, TokenGenerationOptions request) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<Void>> sync(String entityGroupId) {
     ...
     * Sync entity group users. This will add users to entities that do not have them and remove users from entities that have them.
     */
    public CompletableFuture<MercoaHttpResponse<Void>> sync(String entityGroupId, EntityGroupUserSyncRequest request) {
     ...
     * Sync entity group users. This will add users to entities that do not have them and remove users from entities that have them.
     */
    public CompletableFuture<MercoaHttpResponse<Void>> sync(
