...
public class AsyncRawProcessInvoiceClient {
    protected final ClientOptions clientOptions;

    public AsyncRawProcessInvoiceClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<List<InvoiceResponse>>> processInvoices(ProcessInvoiceRequest request) {
     ...
     * Trigger invoice processing
     */
    public CompletableFuture<MercoaHttpResponse<List<InvoiceResponse>>> processInvoices(
