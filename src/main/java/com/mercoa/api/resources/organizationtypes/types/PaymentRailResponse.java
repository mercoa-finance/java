...
public final class PaymentRailResponse {
    ...
    public static PaymentRailResponse wallet(GenericPaymentRailResponse value) {
        return new PaymentRailResponse(new WalletValue(value));
    }
    ...
    public Optional<GenericPaymentRailResponse> getWallet() {
        if (isWallet()) {
    ...
    public interface Visitor<T> {
        ...
        T visitWallet(GenericPaymentRailResponse wallet);
    ...
    private static final class WalletValue implements Value {
        ...
        private WalletValue(GenericPaymentRailResponse value) {
            this.value = value;
        }
