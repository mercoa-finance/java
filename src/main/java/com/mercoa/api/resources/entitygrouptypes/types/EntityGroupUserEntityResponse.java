...
public final class EntityGroupUserEntityResponse implements IEntityGroupUserEntityRequest {
    ...
    private EntityGroupUserEntityResponse(
            List<String> roles, String entityId, String id, Map<String, Object> additionalProperties) {
        this.roles = roles;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EntityGroupUserEntityResponse && equalTo((EntityGroupUserEntityResponse) other);
    }
    ...
    private boolean equalTo(EntityGroupUserEntityResponse other) {
        return roles.equals(other.roles) && entityId.equals(other.entityId) && id.equals(other.id);
    }

    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.roles, this.entityId, this.id);
    }
    ...
    public static final class Builder implements EntityIdStage, IdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(EntityGroupUserEntityResponse other) {
        ...
        @java.lang.Override
        public EntityGroupUserEntityResponse build() {
            return new EntityGroupUserEntityResponse(roles, entityId, id, additionalProperties);
        }
    }
}
