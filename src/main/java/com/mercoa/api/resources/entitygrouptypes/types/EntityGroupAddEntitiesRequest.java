...
public final class EntityGroupAddEntitiesRequest {
     ...
     * <p>If false, users and roles will not be copied.
     ...
     * <p>Note: If users and roles are copied, any preexisting users will be removed from each of the entities set to be added to the group.</p>
     */
