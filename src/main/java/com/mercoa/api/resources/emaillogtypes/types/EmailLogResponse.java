...
public final class EmailLogResponse {
    ...
    /**
     * @return Total number of logs for the given filters. This value is not limited by the limit parameter. It is provided so that you can determine how many pages of results are available.
     */
    @JsonProperty("count")
    public int getCount() {
        return count;
    ...
    /**
     * @return True if there are more logs available for the given filters.
     */
    ...
    public interface CountStage {
        /**
         * <p>Total number of logs for the given filters. This value is not limited by the limit parameter. It is provided so that you can determine how many pages of results are available.</p>
         */
    ...
    public interface HasMoreStage {
        /**
         * <p>True if there are more logs available for the given filters.</p>
         */
