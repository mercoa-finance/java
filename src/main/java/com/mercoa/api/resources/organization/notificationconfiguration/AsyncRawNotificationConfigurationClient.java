...
public class AsyncRawNotificationConfigurationClient {
    protected final ClientOptions clientOptions;

    public AsyncRawNotificationConfigurationClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<List<NotificationConfigurationResponse>>> getAll() {
        return getAll(null);
    }
    ...
    public CompletableFuture<MercoaHttpResponse<List<NotificationConfigurationResponse>>> getAll(
        ...
        CompletableFuture<MercoaHttpResponse<List<NotificationConfigurationResponse>>> future =
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new MercoaHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBody.string(),
                                        new TypeReference<List<NotificationConfigurationResponse>>() {}),
                                response));
                        return;
                    }
     ...
     */
    public CompletableFuture<MercoaHttpResponse<NotificationConfigurationResponse>> get(
    ...
    public CompletableFuture<MercoaHttpResponse<NotificationConfigurationResponse>> get(
        ...
        CompletableFuture<MercoaHttpResponse<NotificationConfigurationResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<NotificationConfigurationResponse>> update(
     ...
     */
    public CompletableFuture<MercoaHttpResponse<Void>> reset(NotificationType notificationType) {
     ...
     * Reset notification configuration for this notification type
     */
    public CompletableFuture<MercoaHttpResponse<Void>> reset(
            NotificationType notificationType, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("organization")
