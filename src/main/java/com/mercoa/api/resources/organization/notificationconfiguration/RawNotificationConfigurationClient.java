...
public class RawNotificationConfigurationClient {
    protected final ClientOptions clientOptions;

    public RawNotificationConfigurationClient(ClientOptions clientOptions) {
     ...
     */
    public MercoaHttpResponse<List<NotificationConfigurationResponse>> getAll() {
        return getAll(null);
    }
     ...
     * Retrieve all notification configurations
     */
    public MercoaHttpResponse<List<NotificationConfigurationResponse>> getAll(RequestOptions requestOptions) {
            ...
            if (response.isSuccessful()) {
                return new MercoaHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(
                                responseBody.string(), new TypeReference<List<NotificationConfigurationResponse>>() {}),
                        response);
            }
     ...
     */
    public MercoaHttpResponse<NotificationConfigurationResponse> get(NotificationType notificationType) {
     ...
     * Retrieve notification configuration for this notification type
     */
    public MercoaHttpResponse<NotificationConfigurationResponse> get(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MercoaHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(
                                responseBody.string(), NotificationConfigurationResponse.class),
                        response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new MercoaApiException(
     ...
     */
    public MercoaHttpResponse<NotificationConfigurationResponse> update(
     ...
     */
    public MercoaHttpResponse<Void> reset(NotificationType notificationType) {
        return reset(notificationType, null);
    }

    /**
     * Reset notification configuration for this notification type
     */
    public MercoaHttpResponse<Void> reset(NotificationType notificationType, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("organization")
                .addPathSegments("notification-configuration")
