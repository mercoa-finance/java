...
public class AsyncRawOrganizationClient {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<OrganizationResponse>> get() {
     ...
     * Get current organization information
     */
    public CompletableFuture<MercoaHttpResponse<OrganizationResponse>> get(GetOrganizationRequest request) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<OrganizationResponse>> get(
            GetOrganizationRequest request, RequestOptions requestOptions) {
        ...
        CompletableFuture<MercoaHttpResponse<OrganizationResponse>> future = new CompletableFuture<>();
     ...
     */
    public CompletableFuture<MercoaHttpResponse<OrganizationResponse>> update() {
     ...
     * Update current organization
     */
    public CompletableFuture<MercoaHttpResponse<OrganizationResponse>> update(OrganizationRequest request) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<OrganizationResponse>> update(
            OrganizationRequest request, RequestOptions requestOptions) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<EmailLogResponse>> emailLog() {
     ...
     * Get log of all emails sent to this organization. Content format subject to change.
     */
    public CompletableFuture<MercoaHttpResponse<EmailLogResponse>> emailLog(GetEmailLogRequest request) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<EmailLogResponse>> emailLog(
            GetEmailLogRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
     ...
     */
    public CompletableFuture<MercoaHttpResponse<Void>> invalidateTokens() {
     ...
     * Invalidate all JWT tokens for the current organization. This is considered a break-glass action and should be used only if tokens have been compromised. All tokens will be invalidated, including tokens on links, emails, and currently logged in sessions. API keys are not affected by this action. This action may take 60 seconds to propagate.
     */
    public CompletableFuture<MercoaHttpResponse<Void>> invalidateTokens(InvalidateTokensRequest request) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<Void>> invalidateTokens(
            InvalidateTokensRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
