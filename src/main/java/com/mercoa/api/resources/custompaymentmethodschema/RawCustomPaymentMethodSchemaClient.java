...
public class RawCustomPaymentMethodSchemaClient {
    protected final ClientOptions clientOptions;

    public RawCustomPaymentMethodSchemaClient(ClientOptions clientOptions) {
     ...
     */
    public MercoaHttpResponse<List<CustomPaymentMethodSchemaResponse>> getAll() {
        return getAll(null);
    }
     ...
     * Get all custom payment method schemas
     */
    public MercoaHttpResponse<List<CustomPaymentMethodSchemaResponse>> getAll(RequestOptions requestOptions) {
     ...
     */
    public MercoaHttpResponse<CustomPaymentMethodSchemaResponse> create(CustomPaymentMethodSchemaRequest request) {
     ...
     * Create custom payment method schema
     */
    public MercoaHttpResponse<CustomPaymentMethodSchemaResponse> create(
     ...
     */
    public MercoaHttpResponse<CustomPaymentMethodSchemaResponse> update(
     ...
     */
    public MercoaHttpResponse<CustomPaymentMethodSchemaResponse> get(String schemaId) {
     ...
     * Get custom payment method schema
     */
    public MercoaHttpResponse<CustomPaymentMethodSchemaResponse> get(String schemaId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("paymentMethod")
                .addPathSegments("schema")
     ...
     */
    public MercoaHttpResponse<Void> delete(String schemaId) {
     ...
     * Delete custom payment method schema. Schema that have been used in an invoice cannot be deleted.
     */
    public MercoaHttpResponse<Void> delete(String schemaId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("paymentMethod")
                .addPathSegments("schema")
