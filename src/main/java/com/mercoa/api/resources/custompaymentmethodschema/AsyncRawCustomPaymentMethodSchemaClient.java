...
public class AsyncRawCustomPaymentMethodSchemaClient {
    protected final ClientOptions clientOptions;

    public AsyncRawCustomPaymentMethodSchemaClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<List<CustomPaymentMethodSchemaResponse>>> getAll() {
        return getAll(null);
    }
    ...
    public CompletableFuture<MercoaHttpResponse<List<CustomPaymentMethodSchemaResponse>>> getAll(
        ...
        CompletableFuture<MercoaHttpResponse<List<CustomPaymentMethodSchemaResponse>>> future =
     ...
     */
    public CompletableFuture<MercoaHttpResponse<CustomPaymentMethodSchemaResponse>> create(
    ...
    public CompletableFuture<MercoaHttpResponse<CustomPaymentMethodSchemaResponse>> create(
        ...
        CompletableFuture<MercoaHttpResponse<CustomPaymentMethodSchemaResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<CustomPaymentMethodSchemaResponse>> update(
     ...
     */
    public CompletableFuture<MercoaHttpResponse<CustomPaymentMethodSchemaResponse>> get(String schemaId) {
     ...
     * Get custom payment method schema
     */
    public CompletableFuture<MercoaHttpResponse<CustomPaymentMethodSchemaResponse>> get(
     ...
     */
    public CompletableFuture<MercoaHttpResponse<Void>> delete(String schemaId) {
     ...
     * Delete custom payment method schema. Schema that have been used in an invoice cannot be deleted.
     */
    public CompletableFuture<MercoaHttpResponse<Void>> delete(String schemaId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("paymentMethod")
                .addPathSegments("schema")
