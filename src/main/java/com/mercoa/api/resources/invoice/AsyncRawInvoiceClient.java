...
public class AsyncRawInvoiceClient {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<FindInvoiceResponse>> find() {
     ...
     * Search invoices for all entities in the organization
     */
    public CompletableFuture<MercoaHttpResponse<FindInvoiceResponse>> find(GetAllInvoicesRequest request) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<FindInvoiceResponse>> find(
            GetAllInvoicesRequest request, RequestOptions requestOptions) {
        ...
        CompletableFuture<MercoaHttpResponse<FindInvoiceResponse>> future = new CompletableFuture<>();
    ...
    public CompletableFuture<MercoaHttpResponse<InvoiceResponse>> create(InvoiceCreationRequest request) {
        return create(request, null);
    }

    public CompletableFuture<MercoaHttpResponse<InvoiceResponse>> create(
            InvoiceCreationRequest request, RequestOptions requestOptions) {
    ...
    public CompletableFuture<MercoaHttpResponse<InvoiceResponse>> get(String invoiceId) {
        return get(invoiceId, null);
    }

    public CompletableFuture<MercoaHttpResponse<InvoiceResponse>> get(String invoiceId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("invoice")
    ...
    public CompletableFuture<MercoaHttpResponse<InvoiceResponse>> update(String invoiceId) {
    ...
    public CompletableFuture<MercoaHttpResponse<InvoiceResponse>> update(
            String invoiceId, InvoiceUpdateRequest request) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<Void>> delete(String invoiceId) {
     ...
     * Only invoices in the UNASSIGNED and DRAFT statuses can be deleted.
     */
    public CompletableFuture<MercoaHttpResponse<Void>> delete(String invoiceId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("invoice")
                .addPathSegment(invoiceId)
     ...
     */
    public CompletableFuture<MercoaHttpResponse<InvoiceEventsResponse>> events(String invoiceId) {
     ...
     * Get all events for an invoice
     */
    public CompletableFuture<MercoaHttpResponse<InvoiceEventsResponse>> events(
            String invoiceId, InvoiceInvoiceGetEventsRequest request) {
    ...
    public CompletableFuture<MercoaHttpResponse<InvoiceEventsResponse>> events(
        ...
        CompletableFuture<MercoaHttpResponse<InvoiceEventsResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
