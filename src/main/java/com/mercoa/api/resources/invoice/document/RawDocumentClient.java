...
public class RawDocumentClient {
     ...
     */
    public MercoaHttpResponse<List<DocumentResponse>> getAll(String invoiceId) {
     ...
     * Get attachments (scanned/uploaded PDFs and images) associated with this invoice
     */
    public MercoaHttpResponse<List<DocumentResponse>> getAll(String invoiceId, GetDocumentsRequest request) {
     ...
     * Get attachments (scanned/uploaded PDFs and images) associated with this invoice
     */
    public MercoaHttpResponse<List<DocumentResponse>> getAll(
     ...
     */
    public MercoaHttpResponse<Void> upload(String invoiceId, UploadDocumentRequest request) {
     ...
     * Upload documents (scanned/uploaded PDFs and images) associated with this Invoice
     */
    public MercoaHttpResponse<Void> upload(
     ...
     */
    public MercoaHttpResponse<Void> delete(String invoiceId, String documentId) {
     ...
     * Delete an attachment (scanned/uploaded PDFs and images) associated with this invoice
     */
    public MercoaHttpResponse<Void> delete(String invoiceId, String documentId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("invoice")
                .addPathSegment(invoiceId)
     ...
     */
    public MercoaHttpResponse<DocumentResponse> generateInvoicePdf(String invoiceId) {
     ...
     * Generate a PDF of the invoice. This PDF is generated from the data in the invoice, not from the uploaded documents.
     */
    public MercoaHttpResponse<DocumentResponse> generateInvoicePdf(String invoiceId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("invoice")
                .addPathSegment(invoiceId)
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MercoaHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), DocumentResponse.class), response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new MercoaApiException(
                    "Error with status code " + response.code(),
     ...
     */
    public MercoaHttpResponse<DocumentResponse> generateCheckPdf(String invoiceId) {
     ...
     * Get a PDF of the check for the invoice. If the invoice does not have check as the disbursement method, an error will be returned. If the disbursement option for the check is set to 'MAIL', a void copy of the check will be returned. If the disbursement option for the check is set to 'PRINT', a printable check will be returned. If the invoice is NOT marked as PAID, the check will be a void copy.
     */
    public MercoaHttpResponse<DocumentResponse> generateCheckPdf(String invoiceId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("invoice")
                .addPathSegment(invoiceId)
     ...
     */
    public MercoaHttpResponse<DocumentResponse> generatePaymentConfirmationPdf(String invoiceId) {
     ...
     * Generate a PDF of the payment confirmation for the invoice. This PDF is generated from the data in the invoice, not from the uploaded documents.
     */
    public MercoaHttpResponse<DocumentResponse> generatePaymentConfirmationPdf(
     ...
     */
    public MercoaHttpResponse<EmailLogResponse> getSourceEmail(String invoiceId) {
     ...
     * Get the email subject and body that was used to create this invoice.
     */
    public MercoaHttpResponse<EmailLogResponse> getSourceEmail(String invoiceId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("invoice")
                .addPathSegment(invoiceId)
