...
public class RawCollectionClient {
    protected final ClientOptions clientOptions;

    public RawCollectionClient(ClientOptions clientOptions) {
     ...
     */
    public MercoaHttpResponse<Optional<ActionResponse>> getNextAction(String invoiceId) {
     ...
     * Get the collection agent's next action on this invoice. This endpoint will return an empty object if there is no action to return.
     */
    public MercoaHttpResponse<Optional<ActionResponse>> getNextAction(String invoiceId, RequestOptions requestOptions) {
     ...
     */
    public MercoaHttpResponse<ActionResponse> updateNextAction(String invoiceId, UpdateNextActionRequest request) {
     ...
     * Update the collection agent's next action on this invoice with natural language. Note that updating any APPROVED action will reset the action to SUGGESTED.  This endpoint will throw an error if there is no action to update.
     */
    public MercoaHttpResponse<ActionResponse> updateNextAction(
     ...
     */
    public MercoaHttpResponse<ActionResponse> approveNextAction(String invoiceId) {
     ...
     * Approve the collection agent's next action on this invoice. This endpoint will throw an error if there is no action to approve.
     */
    public MercoaHttpResponse<ActionResponse> approveNextAction(String invoiceId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("invoice")
                .addPathSegment(invoiceId)
