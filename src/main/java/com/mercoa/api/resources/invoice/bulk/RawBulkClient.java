...
public class RawBulkClient {
     ...
     */
    public MercoaHttpResponse<BulkInvoiceCreationResponse> create(BulkInvoiceCreationRequest request) {
     ...
     * Create multiple invoices in bulk. This endpoint will process synchronously and return a list of invoices that were created or failed to create.
     */
    public MercoaHttpResponse<BulkInvoiceCreationResponse> create(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MercoaHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), BulkInvoiceCreationResponse.class),
                        response);
            }
     ...
     */
    public MercoaHttpResponse<BulkInvoiceUpdateResponse> update(BulkInvoiceUpdateRequest request) {
     ...
     * Update multiple invoices in bulk. This endpoint will process synchronously and return a list of invoices that were updated or failed to update.
     */
    public MercoaHttpResponse<BulkInvoiceUpdateResponse> update(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MercoaHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), BulkInvoiceUpdateResponse.class),
                        response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new MercoaApiException(
     ...
     */
    public MercoaHttpResponse<BulkInvoiceApprovalResponse> approve(BulkInvoiceApprovalRequest request) {
     ...
     * Approve multiple invoices in bulk. This endpoint will process synchronously and return a list of invoices that were approved or failed to approve.
     */
    public MercoaHttpResponse<BulkInvoiceApprovalResponse> approve(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MercoaHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), BulkInvoiceApprovalResponse.class),
                        response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new MercoaApiException(
     ...
     * Get a URL to download a bulk invoice as a CSV/JSON file.
     */
    public MercoaHttpResponse<BulkDownloadResponse> download(DownloadBulkInvoicesRequest request) {
