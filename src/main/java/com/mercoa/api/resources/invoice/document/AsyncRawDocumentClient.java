...
public class AsyncRawDocumentClient {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<List<DocumentResponse>>> getAll(String invoiceId) {
     ...
     * Get attachments (scanned/uploaded PDFs and images) associated with this invoice
     */
    public CompletableFuture<MercoaHttpResponse<List<DocumentResponse>>> getAll(
            String invoiceId, GetDocumentsRequest request) {
    ...
    public CompletableFuture<MercoaHttpResponse<List<DocumentResponse>>> getAll(
        ...
        CompletableFuture<MercoaHttpResponse<List<DocumentResponse>>> future = new CompletableFuture<>();
     ...
     */
    public CompletableFuture<MercoaHttpResponse<Void>> upload(String invoiceId, UploadDocumentRequest request) {
     ...
     * Upload documents (scanned/uploaded PDFs and images) associated with this Invoice
     */
    public CompletableFuture<MercoaHttpResponse<Void>> upload(
     ...
     */
    public CompletableFuture<MercoaHttpResponse<Void>> delete(String invoiceId, String documentId) {
    ...
    public CompletableFuture<MercoaHttpResponse<Void>> delete(
            String invoiceId, String documentId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("invoice")
                .addPathSegment(invoiceId)
     ...
     */
    public CompletableFuture<MercoaHttpResponse<DocumentResponse>> generateInvoicePdf(String invoiceId) {
     ...
     * Generate a PDF of the invoice. This PDF is generated from the data in the invoice, not from the uploaded documents.
     */
    public CompletableFuture<MercoaHttpResponse<DocumentResponse>> generateInvoicePdf(
        ...
        CompletableFuture<MercoaHttpResponse<DocumentResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<DocumentResponse>> generateCheckPdf(String invoiceId) {
     ...
     * Get a PDF of the check for the invoice. If the invoice does not have check as the disbursement method, an error will be returned. If the disbursement option for the check is set to 'MAIL', a void copy of the check will be returned. If the disbursement option for the check is set to 'PRINT', a printable check will be returned. If the invoice is NOT marked as PAID, the check will be a void copy.
     */
    public CompletableFuture<MercoaHttpResponse<DocumentResponse>> generateCheckPdf(
            String invoiceId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("invoice")
     ...
     */
    public CompletableFuture<MercoaHttpResponse<DocumentResponse>> generatePaymentConfirmationPdf(String invoiceId) {
        return generatePaymentConfirmationPdf(invoiceId, null);
    }

    /**
     * Generate a PDF of the payment confirmation for the invoice. This PDF is generated from the data in the invoice, not from the uploaded documents.
     */
    public CompletableFuture<MercoaHttpResponse<DocumentResponse>> generatePaymentConfirmationPdf(
            String invoiceId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("invoice")
                .addPathSegment(invoiceId)
                .addPathSegments("payment-confirmation/generate")
                .build();
        Request okhttpRequest = new Request.Builder()
                .url(httpUrl)
                .method("GET", null)
     ...
     */
    public CompletableFuture<MercoaHttpResponse<EmailLogResponse>> getSourceEmail(String invoiceId) {
     ...
     * Get the email subject and body that was used to create this invoice.
     */
    public CompletableFuture<MercoaHttpResponse<EmailLogResponse>> getSourceEmail(
            String invoiceId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("invoice")
