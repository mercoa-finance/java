...
public class AsyncRawContractClient {
    protected final ClientOptions clientOptions;

    public AsyncRawContractClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<GenerateContractResponse>> generateContract(
    ...
    public CompletableFuture<MercoaHttpResponse<GenerateContractResponse>> generateContract(
        ...
        CompletableFuture<MercoaHttpResponse<GenerateContractResponse>> future = new CompletableFuture<>();
     ...
     */
    public CompletableFuture<MercoaHttpResponse<GenerateContractAsyncResponse>> generateContractRunAsync(
            GenerateContractRequest request) {
    ...
    public CompletableFuture<MercoaHttpResponse<GenerateContractAsyncResponse>> generateContractRunAsync(
        ...
        CompletableFuture<MercoaHttpResponse<GenerateContractAsyncResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<GenerateContractAsyncJobResponse>> generateContractGetAsync(
            String jobId) {
    ...
    public CompletableFuture<MercoaHttpResponse<GenerateContractAsyncJobResponse>> generateContractGetAsync(
        ...
        CompletableFuture<MercoaHttpResponse<GenerateContractAsyncJobResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<List<InvoiceResponse>>> previewInvoices(
            PreviewContractInvoicesRequest request) {
    ...
    public CompletableFuture<MercoaHttpResponse<List<InvoiceResponse>>> previewInvoices(
        ...
        CompletableFuture<MercoaHttpResponse<List<InvoiceResponse>>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<ContractResponse>> applyContractFeedback(
    ...
    public CompletableFuture<MercoaHttpResponse<ContractResponse>> applyContractFeedback(
        ...
        CompletableFuture<MercoaHttpResponse<ContractResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<InvoiceResponse>> applyInvoiceFeedback(
     ...
     */
    public CompletableFuture<MercoaHttpResponse<FindContractResponse>> find() {
     ...
     * Search contracts for all entities in the organization
     */
    public CompletableFuture<MercoaHttpResponse<FindContractResponse>> find(FindContractRequest request) {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<FindContractResponse>> find(
            FindContractRequest request, RequestOptions requestOptions) {
        ...
        CompletableFuture<MercoaHttpResponse<FindContractResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<MercoaHttpResponse<ContractResponse>> create(ContractCreateRequest request) {
        return create(request, null);
    }

    public CompletableFuture<MercoaHttpResponse<ContractResponse>> create(
            ContractCreateRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("contract")
                .build();
    ...
    public CompletableFuture<MercoaHttpResponse<ContractResponse>> get(String contractId) {
        return get(contractId, null);
    }

    public CompletableFuture<MercoaHttpResponse<ContractResponse>> get(
            String contractId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("contract")
                .addPathSegment(contractId)
    ...
    public CompletableFuture<MercoaHttpResponse<ContractResponse>> update(String contractId) {
        return update(contractId, ContractUpdateRequest.builder().build());
    }

    public CompletableFuture<MercoaHttpResponse<ContractResponse>> update(
            String contractId, ContractUpdateRequest request) {
    ...
    public CompletableFuture<MercoaHttpResponse<Void>> delete(String contractId) {
        return delete(contractId, null);
    }

    public CompletableFuture<MercoaHttpResponse<Void>> delete(String contractId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("contract")
                .addPathSegment(contractId)
