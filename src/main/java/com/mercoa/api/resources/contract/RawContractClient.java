...
public class RawContractClient {
    protected final ClientOptions clientOptions;

    public RawContractClient(ClientOptions clientOptions) {
     ...
     */
    public MercoaHttpResponse<GenerateContractResponse> generateContract(GenerateContractRequest request) {
     ...
     * Generate a new contract object from a Base64 encoded PDF of a contract. This endpoint will block until the contract is generated.
     */
    public MercoaHttpResponse<GenerateContractResponse> generateContract(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MercoaHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), GenerateContractResponse.class),
                        response);
            }
     ...
     */
    public MercoaHttpResponse<GenerateContractAsyncResponse> generateContractRunAsync(GenerateContractRequest request) {
     ...
     * Generate a new contract object from a Base64 encoded PDF of a contract. This endpoint will return immediately and the contract will be generated asynchronously.
     */
    public MercoaHttpResponse<GenerateContractAsyncResponse> generateContractRunAsync(
            GenerateContractRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MercoaHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), GenerateContractAsyncResponse.class),
                        response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new MercoaApiException(
     ...
     */
    public MercoaHttpResponse<GenerateContractAsyncJobResponse> generateContractGetAsync(String jobId) {
     ...
     * Get the status and results of an asynchronous contract generation job.
     */
    public MercoaHttpResponse<GenerateContractAsyncJobResponse> generateContractGetAsync(
     ...
     */
    public MercoaHttpResponse<List<InvoiceResponse>> previewInvoices(PreviewContractInvoicesRequest request) {
     ...
     * Generate previews of the invoices that will be created from the provided contract.
     */
    public MercoaHttpResponse<List<InvoiceResponse>> previewInvoices(
     ...
     */
    public MercoaHttpResponse<ContractResponse> applyContractFeedback(
    ...
    public MercoaHttpResponse<ContractResponse> applyContractFeedback(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MercoaHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), ContractResponse.class), response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new MercoaApiException(
                    "Error with status code " + response.code(),
     ...
     */
    public MercoaHttpResponse<InvoiceResponse> applyInvoiceFeedback(
     ...
     */
    public MercoaHttpResponse<FindContractResponse> find() {
     ...
     * Search contracts for all entities in the organization
     */
    public MercoaHttpResponse<FindContractResponse> find(FindContractRequest request) {
     ...
     * Search contracts for all entities in the organization
     */
    public MercoaHttpResponse<FindContractResponse> find(FindContractRequest request, RequestOptions requestOptions) {
    ...
    public MercoaHttpResponse<ContractResponse> create(ContractCreateRequest request) {
        return create(request, null);
    }

    public MercoaHttpResponse<ContractResponse> create(ContractCreateRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("contract")
                .build();
    ...
    public MercoaHttpResponse<ContractResponse> get(String contractId) {
        return get(contractId, null);
    }

    public MercoaHttpResponse<ContractResponse> get(String contractId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("contract")
                .addPathSegment(contractId)
    ...
    public MercoaHttpResponse<ContractResponse> update(String contractId) {
        return update(contractId, ContractUpdateRequest.builder().build());
    }

    public MercoaHttpResponse<ContractResponse> update(String contractId, ContractUpdateRequest request) {
        return update(contractId, request, null);
    }

    public MercoaHttpResponse<ContractResponse> update(
    ...
    public MercoaHttpResponse<Void> delete(String contractId) {
        return delete(contractId, null);
    }

    public MercoaHttpResponse<Void> delete(String contractId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("contract")
                .addPathSegment(contractId)
