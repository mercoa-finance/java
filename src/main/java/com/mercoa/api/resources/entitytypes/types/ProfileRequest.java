...
public final class ProfileRequest {
    ...
    private ProfileRequest(Optional<BusinessProfileRequest> business, Optional<IndividualProfileRequest> individual) {
    ...
    public static final class Builder {
        ...
        public ProfileRequest build() {
            return new ProfileRequest(business, individual);
        }
    }
}
