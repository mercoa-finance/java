...
public final class BulkEntityCreationFromObjectResponse {
    ...
    /**
     * @return If provided, this is the foreign ID of the entity that was created.
     */
    ...
    public static final class Builder {
        ...
        /**
         * <p>The ID of the entity that was created. If the entity was not created, this will be undefined</p>
         */
        ...
        /**
         * <p>If provided, this is the foreign ID of the entity that was created.</p>
         */
        ...
        /**
         * <p>The error message if the entity was not created</p>
         */
        ...
        public BulkEntityCreationFromObjectResponse build() {
            return new BulkEntityCreationFromObjectResponse(id, foreignId, error, additionalProperties);
        }
    }
}
