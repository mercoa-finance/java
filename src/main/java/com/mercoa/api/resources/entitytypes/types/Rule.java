...
public final class Rule {
    ...
    public static Rule approver(ApproverRule value) {
    ...
    private static final class ApproverValue implements Value {
        @JsonUnwrapped
        private ApproverRule value;

        @JsonCreator(mode = JsonCreator.Mode.PROPERTIES)
        private ApproverValue() {}

        private ApproverValue(ApproverRule value) {
            this.value = value;
        }

        @java.lang.Override
        public <T> T visit(Visitor<T> visitor) {
            return visitor.visitApprover(value);
        }

        @java.lang.Override
        public boolean equals(Object other) {
            if (this == other) return true;
            return other instanceof ApproverValue && equalTo((ApproverValue) other);
        }
