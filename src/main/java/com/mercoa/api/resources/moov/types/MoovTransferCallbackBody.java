...
@JsonDeserialize(builder = MoovTransferCallbackBody.Builder.class)
public final class MoovTransferCallbackBody implements IMoovWebhookBase {
    ...
    private final MoovTransferData data;

    private final Map<String, Object> additionalProperties;

    private MoovTransferCallbackBody(
            String eventId,
            String type,
            String createdOn,
            MoovTransferData data,
    ...
    @JsonProperty("data")
    public MoovTransferData getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof MoovTransferCallbackBody && equalTo((MoovTransferCallbackBody) other);
    }
    ...
    private boolean equalTo(MoovTransferCallbackBody other) {
    ...
    public interface EventIdStage {
        ...
        Builder from(MoovTransferCallbackBody other);
    }
    ...
    public interface DataStage {
        _FinalStage data(@NotNull MoovTransferData data);
    }

    public interface _FinalStage {
        MoovTransferCallbackBody build();
    }
    ...
    public static final class Builder implements EventIdStage, TypeStage, CreatedOnStage, DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(MoovTransferCallbackBody other) {
        ...
        @java.lang.Override
        @JsonSetter("data")
        public _FinalStage data(@NotNull MoovTransferData data) {
            this.data = Objects.requireNonNull(data, "data must not be null");
            return this;
        }

        @java.lang.Override
        public MoovTransferCallbackBody build() {
            return new MoovTransferCallbackBody(eventId, type, createdOn, data, additionalProperties);
        }
    }
}
