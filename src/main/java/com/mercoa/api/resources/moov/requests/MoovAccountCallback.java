...
import com.mercoa.api.resources.moov.types.MoovAccountCallbackBody;
...
@JsonDeserialize(builder = MoovAccountCallback.Builder.class)
public final class MoovAccountCallback {
    ...
    private final MoovAccountCallbackBody body;

    private final Map<String, Object> additionalProperties;

    private MoovAccountCallback(
            String xAccountId,
            String xSignature,
            String xTimestamp,
            String xNonce,
            String xWebhookId,
            MoovAccountCallbackBody body,
    ...
    @JsonProperty("body")
    public MoovAccountCallbackBody getBody() {
        return body;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof MoovAccountCallback && equalTo((MoovAccountCallback) other);
    }
    ...
    private boolean equalTo(MoovAccountCallback other) {
    ...
    public interface XAccountIdStage {
        ...
        Builder from(MoovAccountCallback other);
    }
    ...
    public interface BodyStage {
        _FinalStage body(@NotNull MoovAccountCallbackBody body);
    }

    public interface _FinalStage {
        MoovAccountCallback build();
    }
    ...
    public static final class Builder
        ...
        private MoovAccountCallbackBody body;
        ...
        @java.lang.Override
        public Builder from(MoovAccountCallback other) {
        ...
        @java.lang.Override
        @JsonSetter("body")
        public _FinalStage body(@NotNull MoovAccountCallbackBody body) {
            this.body = Objects.requireNonNull(body, "body must not be null");
            return this;
        }

        @java.lang.Override
        public MoovAccountCallback build() {
            return new MoovAccountCallback(
