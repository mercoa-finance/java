...
@JsonDeserialize(builder = MoovBankAccountCallbackBody.Builder.class)
public final class MoovBankAccountCallbackBody implements IMoovWebhookBase {
    ...
    private final MoovBankAccountData data;

    private final Map<String, Object> additionalProperties;

    private MoovBankAccountCallbackBody(
            String eventId,
            String type,
            String createdOn,
            MoovBankAccountData data,
    ...
    @JsonProperty("data")
    public MoovBankAccountData getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof MoovBankAccountCallbackBody && equalTo((MoovBankAccountCallbackBody) other);
    }
    ...
    private boolean equalTo(MoovBankAccountCallbackBody other) {
    ...
    public interface EventIdStage {
        ...
        Builder from(MoovBankAccountCallbackBody other);
    }
    ...
    public interface DataStage {
        _FinalStage data(@NotNull MoovBankAccountData data);
    }

    public interface _FinalStage {
        MoovBankAccountCallbackBody build();
    }
    ...
    public static final class Builder implements EventIdStage, TypeStage, CreatedOnStage, DataStage, _FinalStage {
        ...
        private MoovBankAccountData data;
        ...
        @java.lang.Override
        public Builder from(MoovBankAccountCallbackBody other) {
        ...
        @java.lang.Override
        @JsonSetter("data")
        public _FinalStage data(@NotNull MoovBankAccountData data) {
            this.data = Objects.requireNonNull(data, "data must not be null");
            return this;
        }

        @java.lang.Override
        public MoovBankAccountCallbackBody build() {
            return new MoovBankAccountCallbackBody(eventId, type, createdOn, data, additionalProperties);
        }
    }
}
