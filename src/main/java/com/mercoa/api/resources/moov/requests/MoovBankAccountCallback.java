...
import com.mercoa.api.resources.moov.types.MoovBankAccountCallbackBody;
...
@JsonDeserialize(builder = MoovBankAccountCallback.Builder.class)
public final class MoovBankAccountCallback {
    ...
    private final MoovBankAccountCallbackBody body;

    private final Map<String, Object> additionalProperties;

    private MoovBankAccountCallback(
            String xAccountId,
            String xSignature,
            String xTimestamp,
            String xNonce,
            String xWebhookId,
            MoovBankAccountCallbackBody body,
    ...
    @JsonProperty("body")
    public MoovBankAccountCallbackBody getBody() {
        return body;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof MoovBankAccountCallback && equalTo((MoovBankAccountCallback) other);
    }
    ...
    private boolean equalTo(MoovBankAccountCallback other) {
    ...
    public interface XAccountIdStage {
        ...
        Builder from(MoovBankAccountCallback other);
    }
    ...
    public interface BodyStage {
        _FinalStage body(@NotNull MoovBankAccountCallbackBody body);
    }

    public interface _FinalStage {
        MoovBankAccountCallback build();
    }
    ...
    public static final class Builder
        ...
        private MoovBankAccountCallbackBody body;
        ...
        @java.lang.Override
        public Builder from(MoovBankAccountCallback other) {
        ...
        @java.lang.Override
        @JsonSetter("body")
        public _FinalStage body(@NotNull MoovBankAccountCallbackBody body) {
            this.body = Objects.requireNonNull(body, "body must not be null");
            return this;
        }

        @java.lang.Override
        public MoovBankAccountCallback build() {
            return new MoovBankAccountCallback(
