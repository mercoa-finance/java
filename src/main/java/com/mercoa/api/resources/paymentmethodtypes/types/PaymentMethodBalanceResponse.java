...
public final class PaymentMethodBalanceResponse {
    ...
    public interface CurrencyStage {
        StatusStage currency(@NotNull CurrencyCode currency);
    }
    ...
    public interface StatusStage {
         ...
         */
        _FinalStage status(@NotNull PaymentMethodBalanceStatus status);
    }
    ...
    public static final class Builder implements AvailableBalanceStage, CurrencyStage, StatusStage, _FinalStage {
        ...
        @java.lang.Override
        @JsonSetter("currency")
        public StatusStage currency(@NotNull CurrencyCode currency) {
        ...
        @java.lang.Override
        @JsonSetter("status")
        public _FinalStage status(@NotNull PaymentMethodBalanceStatus status) {
