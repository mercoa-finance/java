...
public class AsyncRawValidateClient {
     ...
     */
    public CompletableFuture<MercoaHttpResponse<TriggerPaymentGatewayValidationResponse>> trigger(
    ...
    public CompletableFuture<MercoaHttpResponse<TriggerPaymentGatewayValidationResponse>> trigger(
        ...
        CompletableFuture<MercoaHttpResponse<TriggerPaymentGatewayValidationResponse>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
