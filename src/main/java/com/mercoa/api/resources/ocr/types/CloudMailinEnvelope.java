...
public final class CloudMailinEnvelope {
    ...
    public interface ToStage {
        FromStage to(String to);

        Builder from(CloudMailinEnvelope other);
    }

    public interface FromStage {
        HeloDomainStage from(String from);
    }

    public interface HeloDomainStage {
        RemoteIpStage heloDomain(String heloDomain);
    }

    public interface RemoteIpStage {
        SpfStage remoteIp(String remoteIp);
    }
    ...
    public static final class Builder
        ...
        @Override
        @JsonSetter("from")
        public HeloDomainStage from(String from) {
            this.from = from;
            return this;
        }
        ...
        public RemoteIpStage heloDomain(String heloDomain) {
            this.heloDomain = heloDomain;
            return this;
        }
        ...
        public SpfStage remoteIp(String remoteIp) {
            this.remoteIp = remoteIp;
            return this;
        }
        ...
        public _FinalStage tlsCipher(String tlsCipher) {
            this.tlsCipher = Optional.of(tlsCipher);
            return this;
        }
